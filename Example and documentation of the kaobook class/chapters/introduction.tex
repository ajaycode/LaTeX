...
Source to format python code that is placed in tex file
\usepackage{minted}
\usemintedstyle{bw}
...
\end{lstlisting}
\captionof{lstlisting}{source to format python code that is placed in tex file}
...
\begin{listing}
\inputminted[linenos=true]{C++}{hello.cpp}
\end{listing}

\clearpage
\begin{lstlisting}[style=kaolstplain,linewidth=1.5\textwidth]
Source to include a Kotlin file and have it span multiple pages
\begin{longlisting}
\inputminted[linenos=true, breaklines]{Kotlin}{Employee.kt}
...
\end{longlisting}
\end{lstlisting}
\captionof{lstlisting}{Source to include a Kotlin file and have it span multiple pages}
